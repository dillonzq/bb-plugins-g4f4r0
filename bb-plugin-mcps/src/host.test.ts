...
(globalThis as { require?: NodeRequire }).require = createRequire(fileURLToPath(import.meta.url));
const { experimental_createHostEntryHarness } = await import("@get-bb/plugin-sdk/testing/host");
