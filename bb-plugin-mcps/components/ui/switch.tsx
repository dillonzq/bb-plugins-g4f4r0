...
>(({ checked, className, disabled, size = "sm", onCheckedChange, onClick, ...props }, ref) => (
  <button
    {...props}
    ref={ref}
    type="button"
  ...
  >
    <span
      ...
      className={cn(
        ...
        size === "default" ? "size-4 data-[state=checked]:translate-x-4" : "size-3 data-[state=checked]:translate-x-3",
      )}
    />
  </button>
));
