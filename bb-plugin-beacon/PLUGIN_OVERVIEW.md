...
Needs BB 0.43 or newer. It inspects only the BB server host, not other enrolled machines or containers. Detailed network rates need Linux. Memory and swap counters need Linux or macOS. A process can show more than 100% CPU because that figure is a lifetime average relative to one core.
